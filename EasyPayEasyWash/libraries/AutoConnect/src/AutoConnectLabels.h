...
#define AUTOCONNECT_MENULABEL_CONFIGNEW   "ตั้งค่า wifi"
...
#define AUTOCONNECT_MENULABEL_OPENSSIDS   "wifi ที่เคยเชื่อมต่อ"
...
#define AUTOCONNECT_PAGETITLE_STATISTICS "AutoCon statistics"
